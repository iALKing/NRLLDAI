...
if __name__ == '__main__':
    ...
    while counter < 10:
        allNodeFeatureNum = []
        allNodeFeatureNumName = r'../Data/SamLDFeature/SDNEFeature.csv'
    ...
    # 保存图片
    plt.savefig('__10FoldAUC.svg')
    plt.savefig('__10FoldAUC.tif')
    plt.show()
